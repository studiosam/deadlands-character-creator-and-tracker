...
const DEADLANDS_HINDRANCE_CATALOG = [
  ["dl-hindrance-ailin", "Ailin’", "Minor or Major", "-1 (Minor) or -2 (Major) to rolls made to resist Fatigue. A Critical Failure can worsen the condition or create a terminal story moment at Major severity."],
  ...
  ["dl-hindrance-heavy-sleeper", "Heavy Sleeper", "Minor", "-4 to Notice rolls to wake up and -4 to Vigor rolls to stay awake."],
  ["dl-hindrance-lyin-eyes", "Lyin’ Eyes", "Minor", "-1 to Intimidation and Persuasion rolls where lies must be told; also applies to bluffing in poker or faro."],
  ["dl-hindrance-night-terrors", "Night Terrors", "Major", "-1 to all Spirit rolls from constant nightmares."],
  ...
  ["dl-hindrance-talisman", "Talisman", "Minor or Major", "Arcane character suffers -1 (Minor) or -2 (Major) to arcane skill rolls without their talisman. Mad scientists are not eligible."],
  ["dl-hindrance-tenderfoot", "Tenderfoot", "Major", "If wounded, suffers one extra action penalty from the wound. Cannot take Don’t Get ’im Riled!"],
...
const HINDRANCE_SETUP_SUMMARIES = {
  ...
  "swade-hindrance-hard-of-hearing": {
    shortSummary:
      "Minor: -4 to Notice rolls related to hearing. Major: completely deaf; hearing-based Notice rolls fail automatically.",
    severitySummaries: {
      Minor: "-4 to all Notice rolls related to hearing.",
      Major:
...
const DEADLANDS_EDGE_CATALOG = [
  ...
  ["dl-edge-fan-the-hammer", "Fan the Hammer", "Combat", "Seasoned", "Agility d8+, Shooting d8+", "Fully loaded single-action revolver only. Fire up to six shots as one action; each shot is a separate Shooting die at -4. Wild Cards roll one Wild Die. Shooting die results of 1 or 2 may threaten Innocent Bystanders.", ""],
  ["dl-edge-improved-fan-the-hammer", "Improved Fan the Hammer", "Combat", "Heroic", "Agility d10+, Fan the Hammer, Shooting d10+", "As Fan the Hammer, but each shot is at -2 Shooting instead of -4.", ""],
  ["dl-edge-quick-draw", "Quick Draw", "Combat", "Novice", "Agility d8+", "When spending a Benny for an extra Action Card at the start of a round, draw two cards and choose from all available Action Card options. Also gain +2 to Athletics rolls to interrupt or resist interruption.", "Required"],
  ...
  ["dl-edge-born-in-the-saddle", "Born in the Saddle", "Professional", "Novice", "Agility d8+, Riding d6+", "Free reroll on Riding rolls. The character's horse gains +2 Pace and increases its running die by one step in emergencies.", ""],
  ...
  ["dl-edge-tale-teller", "Tale-Teller", "Professional", "Novice", "Performance or Persuasion d8+", "Gain +2 to Persuasion or Performance rolls made to lower a local Fear Level. If the Fear Level is lowered with a raise, the Tale-Teller and supporters gain Conviction.", ""],
  ...
  ["dl-edge-reputation", "Reputation", "Social", "Veteran", "None beyond Rank", "Choose good or bad reputation. Good reputation grants a free reroll on Persuasion rolls with people who know the character's stories. Bad reputation grants +2 to Intimidation rolls against people who know the character's reputation.", "Required"],
  ["dl-edge-grit", "Grit", "Weird", "Veteran", "Spirit d8+, Guts", "Reduces Fear check penalties by 2. Stacks with Brave.", ""],
  ...
  ["dl-edge-fast-as-lightning", "Fast as Lightning", "Legendary", "Legendary", "Agility d10+, Quick", "The character can take a fourth action. Maximum Multi-Action Penalty becomes -6 before any Edge or ability reductions.", ""],
  ...
  ["dl-edge-man-of-a-thousand-faces", "Man of a Thousand Faces", "Organization", "Seasoned", "Agent, Performance d8+", "Gain +2 to Performance rolls when impersonating a general type of person with appropriate clothing. Impersonating a known person applies penalties: -2 if the target has heard of them, -4 if the target has seen them, or -6 for a specific/familiar individual. A disguise kit removes 2 points of those penalties.", ""],
  ...
  ["dl-edge-soul-eater", "Soul Eater", "Arcane", "Veteran", "Harrowed", "After causing at least one Wound with a barehanded Fighting attack, including Claws, make Spirit at -2 as a free action. On success, heal one Wound or one Fatigue level. Extra Wounds do not increase the effect.", ""],
  ["dl-edge-spook", "Spook", "Arcane", "Novice", "Harrowed", "As an action, force one nearby target who can see the Harrowed to make a Fear check at -2. A target cannot be affected more than once in the same general encounter. The Harrowed may take one Fatigue level to affect all valid targets within 12 inches instead.", ""],
  ...
  ["dl-edge-whateley-blood", "Whateley Blood", "Arcane", "Novice", "Arcane Background (Huckster)", "-1 to Persuasion because the character's tainted presence unsettles others. As a free action, the character may suffer one Fatigue level for 5 Power Points or one Wound for 10 Power Points.", ""],
  ...
  ["dl-edge-like-an-oak", "Like an Oak", "Organization", "Veteran", "Grit, Territorial Ranger", "Allies within 12 inches of the Ranger ignore up to 2 points of Fear penalties when making Fear checks. The benefit does not apply if the Ranger fails the Fear check, is Shaken, or is Stunned. If the group checks at the same time, the Ranger resolves first.", ""],
...
const SWADE_CORE_HINDRANCE_CATALOG = [
  ["swade-hindrance-all-thumbs","All Thumbs","Minor","-2 when using mechanical or electrical devices. On a Critical Failure with such a device, it breaks or malfunctions unless the item already has its own failure rule."],
  ...
  ["swade-hindrance-bad-eyes","Bad Eyes","Minor or Major","-1 (Minor) or -2 (Major) to vision-dependent Trait rolls; eyewear can negate but may break."],
  ...
  ["swade-hindrance-blind","Blind","Major","-6 to tasks that require vision and grants a free Edge to offset."],
  ["swade-hindrance-bloodthirsty","Bloodthirsty","Major","Does not take prisoners and tends toward lethal solutions."],
  ["swade-hindrance-cant-swim","Can't Swim","Minor","-2 to all Athletics (Swimming) rolls. Each inch of movement in water costs an additional 3 inches."],
  ["swade-hindrance-cautious","Cautious","Minor","Overplans and avoids rash decisions."],
  ["swade-hindrance-clueless","Clueless","Major","-1 to Common Knowledge and Notice."],
  ["swade-hindrance-clumsy","Clumsy","Major","-2 to Athletics and Stealth."],
  ...
  ["swade-hindrance-elderly","Elderly","Major","Pace is reduced by 1, running rolls are reduced by 1, and Agility, Strength, and Vigor rolls take -1. Grants 5 extra skill points for Smarts-linked skills."],
  ...
  ["swade-hindrance-hard-of-hearing","Hard of Hearing","Minor or Major","Minor: -4 to Notice rolls related to hearing. Major: completely deaf; hearing-based Notice rolls fail automatically."],
  ...
  ["swade-hindrance-outsider","Outsider","Minor or Major","-2 Persuasion outside the character's own group, plus possible legal/social limits as Major."],
  ...
  ["swade-hindrance-phobia","Phobia","Minor or Major","-1 (Minor) or -2 (Major) to Trait rolls in the presence of the feared thing."],
  ...
  ["swade-hindrance-thin-skinned","Thin Skinned","Minor or Major","-2 (Minor) or -4 (Major) when resisting Taunt attacks."],
  ["swade-hindrance-tongue-tied","Tongue-Tied","Major","-1 to speech-based Intimidation, Performance, Persuasion, and Taunt."],
  ["swade-hindrance-ugly","Ugly","Minor or Major","-1 (Minor) or -2 (Major) to Persuasion rolls affected by appearance."],
...
const SWADE_CORE_EDGE_CATALOG = [
  ...
  ["swade-edge-ambidextrous","Ambidextrous","Background","Novice","Novice, Agility d8+","Ignore the -2 off-hand penalty when making Trait rolls with the off hand.","",true],
  ...
  ["swade-edge-berserk","Berserk","Background","Novice","Novice","After being Shaken or Wounded by physical damage, the character may go berserk. While berserk: +2 to Fighting rolls, +2 to Strength rolls, +2 Toughness, -2 Parry, and ignore Wound penalties. A Fighting die result of 1 may hit a random adjacent target. Show as a combat-state reminder, not full automation.","",true],
  ...
  ["swade-edge-brute","Brute","Background","Novice","Novice, Strength d6+, Vigor d6+","Athletics links to Strength instead of Agility, including resistance. Thrown item ranges increase by +1 at Short, +2 at Medium, and +4 at Long.","",true],
  ...
  ["swade-edge-fame","Fame","Background","Novice","Novice","Gain +1 Persuasion when recognized. Performance pay is doubled.","",true],
  ["swade-edge-famous","Famous","Background","Seasoned","Seasoned, Fame","Gain +2 Persuasion when recognized. Performance pay is five times normal.","",true],
  ...
  ["swade-edge-linguist","Linguist","Background","Novice","Novice, Smarts d6+","Knows extra languages equal to half the Smarts die type.","",true],
  ...
  ["swade-edge-brawler","Brawler","Combat","Novice","Novice, Strength d8+, Vigor d8+","Gain +1 Toughness. Fists and feet deal Str+d4 damage.","",true],
  ["swade-edge-bruiser","Bruiser","Combat","Seasoned","Seasoned, Brawler","Gain another +1 Toughness and increase unarmed damage one die step, usually from Str+d4 to Str+d6.","",true],
  ["swade-edge-calculating","Calculating","Combat","Novice","Novice, Smarts d8+","When the character's Action Card is 5 or lower, they may ignore up to 2 points of penalties on one action.","",true],
  ...
  ["swade-edge-free-runner","Free Runner","Combat","Novice","Novice, Agility d8+","Ignores Difficult Ground while on foot. Gains +2 to Athletics rolls for climbing and foot chases.","",true],
  ...
  ["swade-edge-harder-to-kill","Harder to Kill","Combat","Veteran","Veteran, Hard to Kill","If the character dies, roll a die. On an even result, they survive somehow.","",true],
  ...
  ["swade-edge-improvisational-fighter","Improvisational Fighter","Combat","Seasoned","Seasoned, Smarts d6+","Ignore the -2 improvised weapon attack penalty.","",true],
  ...
  ["swade-edge-martial-artist","Martial Artist","Combat","Novice","Novice, Fighting d6+","Gain +1 to unarmed Fighting. Unarmed attacks deal Str+d4 and count as armed/Natural Weapons.","",true],
  ["swade-edge-martial-warrior","Martial Warrior","Combat","Seasoned","Seasoned, Martial Artist","Gain +2 to unarmed Fighting. Unarmed damage improves to Str+d6.","",true],
  ...
  ["swade-edge-rock-and-roll","Rock and Roll!","Combat","Seasoned","Seasoned, Shooting d8+","Ignore the -2 Recoil penalty when firing weapons with RoF 2 or higher.","",true],
  ["swade-edge-steady-hands","Steady Hands","Combat","Novice","Novice, Agility d8+","Ignores Unstable Platform penalties. Reduces the Running penalty from -2 to -1.","",true],
  ...
  ["swade-edge-improved-trademark-weapon","Improved Trademark Weapon","Combat","Seasoned","Seasoned, Trademark Weapon","Chosen weapon bonus increases to +2 attack and Parry.","",true],
  ...
  ["swade-edge-extra-effort","Extra Effort","Arcane","Seasoned","Seasoned, Arcane Background (Gifted), Focus d6+","Spend 1 Power Point for +1 Focus, or 3 Power Points for +2 Focus.","",true],
  ...
  ["swade-edge-holy-unholy-warrior","Holy/Unholy Warrior","Arcane","Seasoned","Seasoned, Arcane Background (Miracles), Faith d6+","Spend 1 to 4 Power Points to add +1 to +4 to a Soak roll, one bonus point per Power Point spent.","",true],
...
const GEAR_CATALOG = [
  ...
  {
    id: 'restaurant-cheap-meal',
    name: 'Restaurant, cheap meal',
    book: "Deadlands",
    category: 'Food & Drink',
    weight: 0,
    costCents: 25,
  ...
  },
  {
    ...
    weight: 0.3,
    costCents: 5,
    notes: 'Weight is 5 pounds per 50 feet.',
  },
  {
    id: 'bedroll',
    name: 'Bedroll',
  ...
  },
  {
    ...
    weight: 5,
    costCents: 100,
    notes: 'Weight is 5 pounds full or 1 pound empty.',
  },
  {
    id: 'cigar',
    name: 'Cigar',
  ...
  },
  {
    ...
    weight: 8,
    costCents: 500,
    notes: 'Each rope can hold 300 pounds plus 50 pounds per raise on the repair roll.',
  },
  {
    id: 'shovel',
    name: 'Shovel',
  ...
  {
    id: 'ghost-rock-ore',
    name: 'Ghost rock ore (1 oz.)',
    book: "Deadlands",
    category: 'Fundaments',
    weight: 0.0625,
    costCents: 625,
    notes: 'Most commonly sold by the pound at $100 per pound.',
  },
  {
    id: 'gold-ore',
    name: 'Gold ore (1 oz.)',
    ...
    weight: 0.0625,
    costCents: 2000,
    notes: 'Fundaments entry priced per ounce.',
  },
  {
    id: 'silver-ore',
    name: 'Silver ore (1 oz.)',
    book: "Deadlands",
    category: 'Fundaments',
    weight: 0.0625,
    costCents: 150,
  ...
  {
    id: 'doctor-visit-office',
    name: 'Doctor visit, office',
    book: "Deadlands",
    category: 'Services',
    weight: 0,
    costCents: 300,
  ...
  {
    id: 'doctor-visit-house-call',
    name: 'Doctor visit, house call',
    book: "Deadlands",
    category: 'Services',
    weight: 0,
    costCents: 500,
  ...
  {
    id: 'boarding-house-meal',
    name: 'Boarding house (w/meals)',
    book: "Deadlands",
    category: 'Services',
    weight: 0,
    costCents: 100,
  ...
  {
    id: 'telegram-per-word',
    name: 'Telegram (per word)',
    book: "Deadlands",
    category: 'Services',
    weight: 0,
    costCents: 5,
  ...
  {
    id: 'riverboat-per-mile',
    name: 'Riverboat (per mile)',
    book: "Deadlands",
    category: 'Transportation',
    weight: 0,
    costCents: 5,
  ...
  {
    id: 'stagecoach-per-mile',
    name: 'Stagecoach (per mile)',
    book: "Deadlands",
    category: 'Transportation',
    weight: 0,
    costCents: 10,
  ...
  {
    id: 'percussion-caps',
    name: 'Percussion caps (box of 60)',
    book: "Deadlands",
    category: 'Ammunition',
    weight: 1,
    costCents: 50,
    notes: 'Box of 60 percussion caps.',
  },
  {
    id: 'shot-w-powder',
    name: 'Shot w/powder',
    ...
    weight: 0.2,
    costCents: 5,
    notes: 'Shot and powder sold per shot.',
  },
  {
    id: 'shotgun-shells',
    name: 'Shotgun shells',
    ...
    weight: 0.1,
    costCents: 10,
    notes: 'Shotgun shells sold per shell.',
  },
  {
    id: 'blasting-cap',
    name: 'Blasting cap',
    ...
    weight: 0.0833,
    costCents: 100,
    notes: 'Weight is 1 pound per 12 caps.',
  },
  {
  ...
  },
  {
    ...
    weight: 0.02,
    costCents: 5,
    notes: 'Weight is 1 pound per 50 feet.',
  },
  {
    id: 'hat-periscope',
    name: 'Hat periscope',
    book: "Deadlands",
    category: 'Infernal Devices - Clothes',
    weight: 12,
    costCents: 20000,
  },
  {
  ...
  },
  {
    ...
    book: "Deadlands",
    category: 'Infernal Devices - Elixirs & Tonics',
    weight: 0,
    costCents: 20000,
  },
  {
  ...
  },
  {
    ...
    name: 'Diving Suit',
    book: "Deadlands",
    category: 'Infernal Devices - Miscellaneous Devices',
    weight: 45,
    costCents: 200000,
  },
  {
...
const ARMOR_CATALOG = [
  ...
  },
  {
    ...
    location: 'torso',
    notes:
      "Torso and upper legs. Reduces frontal headshots to wearer's torso and upper legs by 4.",
  },
  {
    id: 'chaps',
    name: 'Chaps',
...
const VEHICLE_CATALOG = [
  {
    ...
    crew: '1+1',
    costCents: 7500,
    notes: 'Two-wheeled vehicle drawn by one horse. Tabletop Pace is 12; it may run.',
  },
  {
    id: 'carriage',
    name: 'Carriage',
  ...
  },
  {
    ...
    crew: '2+28',
    costCents: 1500000,
    notes: 'Hauls train cars. Needs minimum crew of engineer, boilerman, and brakeman.',
  },
  {
    id: 'stagecoach',
    name: 'Stagecoach',
    ...
    crew: '2+9',
    costCents: 30000,
    notes: 'Larger enclosed vehicle meant to carry passengers from place to place.',
  },
  {
    id: 'train-car',
    name: 'Train Car',
    ...
    crew: 'Varies',
    costCents: 800000,
    notes: 'Holds up to 100 passengers or serves as sleeper car, lounge, dining car, or express car.',
  },
  {
    id: 'wagon',
    name: 'Wagon',
  ...
  },
  {
    ...
    crew: '1+8',
    costCents: 5000,
    notes: 'Flat-bottomed boat used to navigate shallow swamps or creeks.',
  },
  {
    ...
    crew: '6+80',
    costCents: 2000000,
    notes: 'Typical commercial river paddlewheel for hauling laborers or cargo.',
  },
  {
    ...
    crew: '18+400',
    costCents: 5000000,
    notes: 'Luxurious vessel with cargo space, private rooms, and first class passengers.',
  },
  {
    id: 'rail-runner',
    name: 'Rail Runner',
    book: "Deadlands",
    category: 'Infernal Land Vehicles',
    size: '4 (Large)',
    handling: '-1',
    topSpeed: 40,
    toughness: '12 (5)',
    crew: '1+7',
    costCents: 250000,
    notes: 'Luxurious enclosed cabin with rail wheels adjustable to any gauge track.',
  },
  {
    id: 'steam-cart',
    name: 'Steam Cart',
    ...
    crew: '1+5',
    costCents: 80000,
    notes: 'Railroad handcart adapted to steam. Travels 100 miles per one-pound ghost rock fuel core.',
  },
  {
    id: 'steam-wagon',
    name: 'Steam Wagon',
    ...
    crew: '1+5',
    costCents: 150000,
    notes: 'Steam-powered wagon. Travels 50 miles per one-pound ghost rock fuel core.',
  },
  {
    id: 'velocipede',
    name: 'Velocipede',
    ...
    crew: '1',
    costCents: 100000,
    notes: 'Two-wheeled cycle. Travels 75 miles per one-pound ghost rock fuel core.',
  },
  {
    id: 'maze-runner',
    name: 'Maze Runner',
    book: "Deadlands",
    category: 'Infernal Water Vehicles',
    size: '6 (Large)',
    handling: '0',
    topSpeed: 18,
    toughness: '13 (2)',
    crew: '1+7',
    costCents: 1500000,
    notes: 'Medium-sized vessel for the treacherous canals of the Great Maze.',
  },
  {
    id: 'submersible-boat',
    ...
    crew: '2+5',
    costCents: 2000000,
    notes: 'Undersea vessel for scouting, cargo, and smuggling.',
  },
  {
    id: 'air-carriage',
    name: 'Air Carriage',
    book: "Deadlands",
    category: 'Infernal Air Vehicles',
    size: '6 (Large)',
    handling: '-2',
    topSpeed: 50,
    toughness: '16 (4)',
    crew: '2+8',
    costCents: 500000,
    notes: 'Small airship that can hold passengers and cargo.',
  },
  {
    id: 'auto-gyro',
    name: 'Auto-Gyro',
    ...
    crew: '1',
    costCents: 150000,
    notes: 'Carries about 120 pounds of passengers or cargo.',
  },
  {
    ...
    crew: '1+3',
    costCents: 300000,
    notes: 'Steam-powered ornithopter with flapping wings.',
  },
  {
    id: 'rocket-pack',
    name: 'Rocket Pack',
    ...
    crew: '1',
    costCents: 210000,
    notes: 'Lifts up to 300 pounds plus 50 pounds per raise on the Repair roll.',
  },
  {
    id: 'super-gyro',
    name: 'Super Gyro',
    ...
    crew: '1+3',
    costCents: 400000,
    notes: 'S&R famed pilot Super-Gyro. Handles -2 loaded and 0 empty.',
  },
  {
    ...
    crew: '1',
    costCents: 100000,
    notes: 'Handles -1 on rough conditions and -2 in worse weather. Travels 100 miles per one-pound ghost rock fuel core.',
  },
];

...
The first Character Setup implementation creates the shared setup and review shell, with these visible first-slice steps: Concept, Attributes, Skills, Free Edge, Hindrances, Powers, Gear, and Review.
...
- Created-character Hindrance benefit spending, Trait point spending, starting Edge source tracking, and shared starting Edge save/confirm validation for eligible pre-advance characters.

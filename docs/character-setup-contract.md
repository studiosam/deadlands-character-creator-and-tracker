...
Character Setup uses this active step order: Concept, Attributes, Skills, Free Edge, Hindrances, Powers, Gear, and Review.
...
- Character Setup shell for created and imported characters, with Concept, Attributes, Skills, Free Edge, Hindrances, Powers, Gear, and Review steps. `setupStatus` decides whether setup review is needed.

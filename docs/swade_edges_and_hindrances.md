...
| Ambidextrous               | Novice, Agility d8+             | Ignore the -2 off-hand penalty when making Trait rolls with the off hand.                                               | off-hand, dual-wield                                     |
...
| Brute                      | Novice, Strength d6+, Vigor d6+ | Athletics links to Strength instead of Agility, including resistance. Thrown item ranges increase by +1 at Short, +2 at Medium, and +4 at Long. | athletics, strength, thrown-weapons                      |
...
| Fame                       | Novice                          | Gain +1 Persuasion when recognized. Performance pay is doubled.                                                        | fame, persuasion, performance                            |
| Famous                     | Seasoned, Fame                  | Gain +2 Persuasion when recognized. Performance pay is five times normal.                                              | fame, persuasion, improved-edge                          |
...
| Linguist                   | Novice, Smarts d6+              | Knows extra languages equal to half the Smarts die type.                                                               | languages                                                |
...
| Brawler                   | Novice, Strength d8+, Vigor d8+              | Gain +1 Toughness. Fists and feet deal Str+d4 damage.                                                   | unarmed, toughness                     |
| Bruiser                   | Seasoned, Brawler                            | Gain another +1 Toughness and increase unarmed damage one die step, usually from Str+d4 to Str+d6.       | unarmed, toughness, improved-edge      |
...
| Harder to Kill            | Veteran, Hard to Kill                        | If the character dies, roll a die. On an even result, they survive somehow.                             | death-save, story                      |
...
| Improvisational Fighter   | Seasoned, Smarts d6+                         | Ignore the -2 improvised weapon attack penalty.                                                         | improvised-weapons                     |
...
| Martial Artist            | Novice, Fighting d6+                         | Gain +1 to unarmed Fighting. Unarmed attacks deal Str+d4 and count as armed/Natural Weapons.            | unarmed, fighting                      |
| Martial Warrior           | Seasoned, Martial Artist                     | Gain +2 to unarmed Fighting. Unarmed damage improves to Str+d6.                                         | unarmed, fighting, improved-edge       |
...
| Rock and Roll!            | Seasoned, Shooting d8+                       | Ignore the -2 Recoil penalty when firing weapons with RoF 2 or higher.                                  | shooting, recoil                       |
...
| Improved Trademark Weapon | Seasoned, Trademark Weapon                   | Chosen weapon bonus increases to +2 attack and Parry.                                                   | chosen-weapon, improved-edge           |
